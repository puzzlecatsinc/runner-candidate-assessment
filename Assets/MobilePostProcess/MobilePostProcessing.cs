...
public class MobilePostProcessing : MonoBehaviour
{
    ...
    static readonly int vignetteString = Shader.PropertyToID("_Color");
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        if (Vignette)
        {
            material.SetColor(vignetteString, VignetteColor);
        }
        else
        {
            material.SetColor(vignetteString, Color.white);
        }
